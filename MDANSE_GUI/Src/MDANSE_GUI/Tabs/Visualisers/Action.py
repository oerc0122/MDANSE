...
from MDANSE_GUI.InputWidgets import (AseInputFileWidget, AtomMappingWidget,
                                     AtomSelectionWidget,
                                     AtomTransmutationWidget, BackupWidget,
                                     BooleanWidget, ComboWidget,
                                     CorrelationFramesWidget,
                                     DerivativeOrderWidget,
                                     DistHistCutoffWidget, FloatWidget,
                                     FramesWidget, HDFTrajectoryWidget,
                                     InputDirectoryWidget, InputFileWidget,
                                     InstrumentResolutionWidget, IntegerWidget,
                                     InterpolationOrderWidget,
                                     MDAnalysisCoordinateFileWidget,
                                     MDAnalysisMDTrajTimeStepWidget,
                                     MDAnalysisTopologyFileWidget,
                                     MDTrajTopologyFileWidget, MoleculeWidget,
                                     MultiInputFileWidget,
                                     MultipleCombosWidget, OptionalFloatWidget,
                                     OutputDirectoryWidget, OutputFilesWidget,
                                     OutputStructureWidget,
                                     OutputTrajectoryWidget,
                                     PartialChargeWidget, ProjectionWidget,
                                     QVectorsWidget, RangeWidget,
                                     RunningModeWidget, StringWidget,
                                     UnitCellWidget, VectorWidget)
