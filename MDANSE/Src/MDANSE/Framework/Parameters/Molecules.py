...
from .BaseTypes import Integer
from .Choices import DynamicSingleChoice
from .Parameters import ConfigError, Configurable, CustomConfig
...
class MolecularAxis(CustomConfig):
    ...
    def required_deps(self) -> set[str]:
        return super().required_deps() | {"choices", "trajectory"}
    ...
    def __set__(
        self,
        owner: Configurable,
        value: tuple[str, int, ...] | dict[str, str | int] | str,
    ) -> None:
