...
from MDANSE.Framework.Parameters.UtilTypes import CB
...
class MDANSETrajectory(ConfigureDescriptor[str | Path, Trajectory, CB]):
...
class MDANSEResult(ConfigureDescriptor[str | Path | h5py.File, h5py.File, CB]):
